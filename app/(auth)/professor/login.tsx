...
export default function ProfessorLogin() {
  ...
  // Email : professeur@fst.ma | Mot de passe : 12345678
  ...
  const handleLogin = async () => {
    ...
    if (email === MOCK_PROFESSOR.email && password === MOCK_PROFESSOR.password) {
      await AsyncStorage.setItem('token', 'mock-professor-token-xyz');
      await AsyncStorage.setItem('user', JSON.stringify(MOCK_PROFESSOR.user));
      await AsyncStorage.setItem('role', 'professor');
  ...
  return (
    <ScrollView contentContainerStyle={[styles.scrollContainer, { backgroundColor: colors.background }]}>
      ...
      <Text style={[styles.pageType, { color: colors.mutedForeground }]}>Connexion Professeur</Text>
