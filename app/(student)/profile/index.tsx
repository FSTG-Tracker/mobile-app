    ...
    >
      ...
      <View style={styles.avatarSection}>
        ...
        <View style={[styles.roleBadge, { backgroundColor: colors.primary + '18' }]}>
          ...
          <Text style={[styles.roleText, { color: colors.primary }]}>Étudiant</Text>
        </View>
      </View>
      ...
      <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <InfoRow icon="layers"  label="Filière"    value={user?.filiere ?? '–'} colors={colors} />
        <View style={[styles.divider, { backgroundColor: colors.border }]} />
        <InfoRow icon="users"   label="Groupe"     value={user?.groupe ?? '–'}  colors={colors} />
        <View style={[styles.divider, { backgroundColor: colors.border }]} />
        <InfoRow icon="hash"    label="N° Apogée"  value={user?.apogee ?? '–'}  colors={colors} />
      </View>
